...
def parse_arguments(parser):
    ...
    parser.add_argument('--d_text', type=int, default=512, help='Text dimension weibo: 32; change to 512')
    ...
    parser.add_argument('--data_path', type=str, default='MR2_data_split/', help='')
    parser.add_argument('--img_data_path', type=str, default='../MR2/', help='')
    # parser.add_argument('--input_path', type=str, default='../WeiboDataset/weibo/embedding_inputs/', help='')
